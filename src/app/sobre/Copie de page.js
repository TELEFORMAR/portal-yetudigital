...
export default function SobrePage() {
  return (
    <main className="bg-gray-50 min-h-screen">
      ...
      {/* Banner Superior */}
      <section className="relative bg-blue-700 text-white py-24 sm:py-28 px-4 sm:px-6 text-center rounded-b-3xl shadow-md overflow-hidden">
        <div className="absolute inset-0 bg-[url('/fabric-texture.png')] opacity-10 bg-cover bg-center"></div>
